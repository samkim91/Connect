package com.example.chinacompetition.CheckDoc;
...
public class AddImageRCAdapter extends RecyclerView.Adapter<AddImageRCAdapter.ViewHolder> implements OnAddImageRCClickListener {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_list_freelancer, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            image = itemView.findViewById(R.id.image_freelancer_writing_picture);
