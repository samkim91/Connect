        ...
        while(true){
          ...
          // 1대1채팅을 하도록 연결된 클라이언트에게 메세지를 전송한다.
            ...
            if(type.equals("file")){
              ...
              System.out.println("전송받은 파일명 : "+ fileNm);
              //파일에 대한 출력 스트림 생성
              File file = new File("/var/www/html/videos/"+fileNm);
              FileOutputStream fos = new FileOutputStream(file);
              BufferedOutputStream bos = new BufferedOutputStream(fos);
              System.out.println("생성한 파 : "+ fileNm);
